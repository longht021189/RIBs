 ...
 */
public class Router<I extends com.uber.rib.core.Interactor, C extends InteractorBaseComponent> extends RouterBase<I> {
  ...
  @SuppressWarnings("unchecked")
  public Router(C component, I interactor, RibRefWatcher ribRefWatcher, Thread mainThread) {
