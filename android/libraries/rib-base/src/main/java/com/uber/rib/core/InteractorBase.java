...
/**
 * The base implementation for all {@link InteractorBase}s.
 *
...
public abstract class InteractorBase<P, R extends Router>
  ...
  /**
   * Called when detached. The {@link InteractorBase} should do its cleanup here. Note: View will be
   * removed automatically so {@link InteractorBase} doesn't have to remove its view here.
   */
